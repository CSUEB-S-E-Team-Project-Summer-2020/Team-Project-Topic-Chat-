        ...
        buttonLogin.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                    ...
                    JOptionPane.showMessageDialog(LoginOnly.this,
                            "Welcome " + getUsername() + "! You have successfully logged in.","Login",JOptionPane.INFORMATION_MESSAGE);
                    
                    dispose();
            	
            	if(succeess==false){
                    JOptionPane.showMessageDialog(LoginOnly.this,"Your Already Logged in","Login",JOptionPane.ERROR_MESSAGE);
